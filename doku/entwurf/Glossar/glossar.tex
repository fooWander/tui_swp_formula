...
\textbf{uint32}
\hangindent+65pt \hangafter=1 \\
Ein Datentyp für die vorzeichenlose Darstellung von Ganzzahlen. Benötigt 32 Bit für die Zahlendarstellung.\\
...
\hangindent+65pt \hangafter=1 \\
Ein virtueller Server (auch vServer) ist eine Softwarelösung, um mehrere Server auf einer Servermaschine laufen zu lassen. Dabei wird nur vorgegeben, dass der virtuelle Server ein richtiger Server ist, der getrennt von den anderen Servern läuft. Man kann den virtuellen Server allerdings wie einen normalen Server behandeln, bei dem unserem Team vorliegendem vServer von 1&1 ist dies der Fall, als Betriebssystem des Servers wird vom Provider Cent OS 6 emuliert.\\
