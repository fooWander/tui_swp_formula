...
\caption[Encoder-Block]{Block zur Erzeugung eines uint32-Datenstroms}
\end{figure} 
...
\begin{minipage}[b]{7.5cm}
    ...
    \caption[UDP-Block Einstellungen]{UDP-Block zur Einstellung der Netzwerkschnittstelle}
  \end{minipage}
\hfill  
  \begin{minipage}[b]{7.5cm}
    \includegraphics[scale = 1]{ethernet_udp_send_block.png}
    \caption[UDP-Block Senden]{UDP-Block zum Senden eines uint32-Datenstroms}
  \end{minipage}
\end{figure}
