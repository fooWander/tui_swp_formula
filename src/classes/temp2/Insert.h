...
/** \brief Klasse zum Aufbauen einer Verbindung zur Datenbank und Einf\"ugen
*		von Daten.
*
...
*	werden daf\"ur mit Hilfe einer anderen Klasse aus einer Textdatei ausgelesen.
*/
class Insert
{
...
private:
	...
	string pass;		//!< speichert das Passwort f\"ur die Datenbank und den Nutzer.
