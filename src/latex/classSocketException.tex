...
Erzeugt eine \char`\"{}\-Socket\-Exception\char`\"{} mit einem erklärenden Hinweistext. 
\begin{DoxyParams}{Parameter}
{\em message} & Nachricht die den Fehlern beschreibt \\
\hline
{\em inc\-Sys\-Msg} & true falls eine Systemnachricht (von strerror(errno)) sollte zu der für den User bereitgestellten Nachricht hinzugefügt werden. \\
\hline
\end{DoxyParams}
