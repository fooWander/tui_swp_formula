...
Holt den nächsten Datensatz aus den empfangenen Daten. \begin{DoxyReturn}{Returns}
...
Holt die Paketnummer des akutell bearbeiteten Pakets. \begin{DoxyReturn}{Returns}
