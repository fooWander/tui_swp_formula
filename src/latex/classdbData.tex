...
Diese Klasse liest die Zugangsdaten aus einer Textdatei (dbconfig.\-txt) aus und stellt sie über Memberfunktionen bereit. \begin{DoxySeeAlso}{Siehe auch}
...
Wird von \hyperlink{classInsert}{Insert} aufgerufen. \begin{DoxyReturn}{RÃ¼ckgabe}
Die Hostadresse. 
\end{DoxyReturn}
