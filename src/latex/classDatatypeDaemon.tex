...
Diese Funktion liefert die Position des jetzigen Datenwerts im "Ubertragungsvektor der Mikro\-Autobox\-I\-I zur"uck.
...
Sie holt sich ein \hyperlink{classData}{Data} Objekt vom \hyperlink{classDecoder}{Decoder} und extrahiert daraus die Nutzdaten und die Position dieser Daten im Paket. Die Position wird dabei in einer Membervariablen zwischengespeichert. Nachdem der Datentyp bestimmt wurde, wird eine Divison durch eine Zehnerpotenz entsprechend dem jetzt erst extrahierten Wert aus \hyperlink{classData}{Data} durchgef"uhrt, um den Wert auf seine urspr"ungliche Gr"o�e zur"uckzubringen. Dies wird jedoch nur ausgef"uhrt, wenn der Wert vor der "Ubertragung ein Gleitkommawert war. Abschlie�end wird der Wert in einen String umgewandelt, der dann an den Aufrufer zur"uckgegeben wird. 
