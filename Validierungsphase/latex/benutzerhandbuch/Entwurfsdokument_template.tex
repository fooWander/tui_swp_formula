...
Um eine neue Programmversion benutzen zu können, folgen Sie bitte den Anweisungen unter 2.2.2 Punkt 9) bis 13).
...
\subsection{Installation und Einrichtung der benötigten Komponenten bei einer Neuinstallation eines Betriebssystems}
